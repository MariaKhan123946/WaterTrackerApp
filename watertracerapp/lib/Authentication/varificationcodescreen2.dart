...
import 'you_are_varified.dart';

class VerificationCodeScreen2 extends StatefulWidget {
  @override
  _VerificationCodeScreen2State createState() => _VerificationCodeScreen2State();
}
...
class _VerificationCodeScreen2State extends State<VerificationCodeScreen2> {
  ...
  // List to hold the values of the verification code
  List<String> code = ['1', '2', '3', '4']; // Initialize with '1234'
  ...
  Widget _buildCodeInputBox(BuildContext context, int index) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: focusNodes[index].hasFocus  ? AppColors.focusedBorderColor
      ...
      child: Center(
        child: TextField(
          ...
          onTap: () {
            setState(() {}); // Refresh UI to change border color when focused
          },
          onChanged: (value) {
          ...
          controller: TextEditingController(text: code[index]), // Initialize the text field with the code
